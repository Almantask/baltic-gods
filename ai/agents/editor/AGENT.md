...
- Update the checklist and research files in `ai/research/` as you find new, verified information.
- For each myth, follow the formatting rules in `ai/workflows/mythology_researcher_workflow.md`.