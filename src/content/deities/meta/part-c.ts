...
export const mildaMeta: DeityMeta = {
  ...
  locations: [
    {
      id: "aleksotas-temple-claim",
      name: "Aleksotas Temple Claim",
      coordinates: [54.9, 23.9],
      region: "Lithuania",
      description: "Narbutt's 19th-century account places one of Milda's alleged temples in Aleksotas near Kaunas; later scholarship treats the claim as part of a literary reconstruction rather than attested cult practice.",
  ...
  gallery: [],
  materialLegacy: [],
  regionDetails: { en: "Lithuania (Narbutt's 19th-century literary mythology)", lt: "Lietuva (Narbuto XIX a. literatūrinė mitologija)", lv: "Lietuva (Narbutta 19. gadsimta literārā mitoloģija)" },
