...
const translations = {
  en: {
    ...
    home: {
      ...
      deityPlaceholder: "Perkūnas, Saulė...",
      locationPlaceholder: "Aukštaitija, sea, dune...",
    ...
    map: {
      ...
      searchExamples: "Ridge, dune, spring...",
      nearMe: "Near me",
    ...
    location: {
      pageTitle: "Sacred location",
      backToMap: "Back to map",
      viewDeity: "View deity",
      region: "Region",
      siteType: "Site type",
      coordinates: "Coordinates",
      deity: "Related deity",
      ...
      mapTitle: "Map focus",
      mapContext: "Marker centers on this location only.",
  ...
  lt: {
    ...
    home: {
      ...
      deityPlaceholder: "Perkūnas, Saulė...",
      locationPlaceholder: "Aukštaitija, kopos, šaltinis...",
    ...
    map: {
      ...
      markerAction: "Palieskite žymeklį, kad atidarytumėte vietovės aprašą.",
      searchPlaceholder: "Ieškoti vietovės pavadinimo",
      searchExamples: "Kalvagūbris, kopa, šaltinis...",
      nearMe: "Šalia manęs",
    ...
    location: {
      pageTitle: "Šventa vieta",
      backToMap: "Atgal į žemėlapį",
      viewDeity: "Rodyti dievybę",
      region: "Regionas",
      siteType: "Vietos tipas",
      coordinates: "Koordinatės",
      deity: "Susijusi dievybė",
      significance: "Svarba",
      mapTitle: "Žemėlapio centras",
      mapContext: "Žymeklis rodo tik šią vietą.",
      openMap: "Atidaryti visą žemėlapį",
      lithuania: "Lietuva",
      latvia: "Latvija",
    },
    deity: {
  ...
  lv: {
    ...
    home: {
      ...
      deityPlaceholder: "Perkons, Saule...",
      locationPlaceholder: "Augšaitija, kāpa, avots...",
    ...
    map: {
      ...
      searchExamples: "Kalns, kāpa, avots...",
      nearMe: "Pie manis",
      nearMeLoading: "Meklē…",
    ...
    location: {
      pageTitle: "Svētā vieta",
      backToMap: "Atpakaļ uz karti",
      viewDeity: "Skatīt dievību",
      region: "Reģions",
      siteType: "Vietas tips",
      coordinates: "Koordinātas",
      deity: "Saistītā dievība",
      significance: "Nozīme",
      mapTitle: "Kartes fokuss",
      mapContext: "Marķieris rāda tikai šo vietu.",
      openMap: "Atvērt pilnu karti",
      lithuania: "Lietuva",
      latvia: "Latvija",
    },
    deity: {
